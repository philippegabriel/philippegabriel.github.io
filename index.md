...
- [Jira Data Mining, through the JQL and SQL apis, grphing results with gnuplot](https://github.com/philippegabriel/jira)
- [Data mining git logs, to extract code churn and defect density](https://github.com/philippegabriel/XSCodeChurn)
- [Documenting SCM branches with graphviz](https://github.com/philippegabriel/XFormerBranchGraph) 
- [Slackbot, publishing JIRA metrics retrieved through the SQL api](https://github.com/philippegabriel/slackbot)
